                ...
                <form id="editForm" action="/system/module/edit.do" method="post">
                    ...
                    <div class="row data-type" style="margin: 0px">
                        ...
                        <div class="col-md-4 data">
                            <input type="text" class="form-control" placeholder="模块名" name="name">
                        </div>
                        ...
                        <div class="col-md-4 data">
                            <input type="text" class="form-control" placeholder="权限标识" name="cpermission">
                        </div>

                        <div class="col-md-2 title">链接</div>
                        <div class="col-md-4 data">
                            <input type="text" class="form-control" placeholder="链接" name="curl" >
                        </div>
